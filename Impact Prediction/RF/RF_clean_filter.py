...
now = datetime.now()
dt_string = 'RF_cleanfilt_'+now.strftime("%d/%m/%Y")
#dt_string = 'debug'
...
#jbsub -q x86_24h -cores 1x8+1 -mem 64G -out sj_out/RF/RF_cleanfilt.stdout -err sj_out/RF/RF_cleanfilt.stderr python RF_clean_filter.py