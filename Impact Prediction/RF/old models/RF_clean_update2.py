...
now = datetime.now()
dt_string = 'RF_cleanupd2_'+now.strftime("%d/%m/%Y")
#dt_string = 'debug'
...
#jbsub -q x86_24h -cores 1x8+1 -mem 64G -out sj_out/RF/RF_cleanupd2.stdout -err sj_out/RF/RF_cleanupd2.stderr python RF_clean_update2.py