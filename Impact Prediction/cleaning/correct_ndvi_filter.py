...
# python correct_ndvi_filter.py --sample_type pixel_data --exp_raw filtered --exp filtered_clean --cp_idx 14 --b2_idx 6 --ndvi_idx 15 --b2_thresh 0.1 --ts_len 9 --len_preds 1 --split test_vaud