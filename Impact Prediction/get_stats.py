...
def get_stats(split, sample_type, exp, start_idx, config_id, samples_per_job, name_start_idx):
    """
    ...
    # Create dataloader
    train_dl = DataLoader(train_ds, sampler=train_sampler, num_workers=2)
    ...
    save_dataset_stats([all_band_means_or_mins,all_band_stds_or_maxs], sample_type, exp, config_id +f'_{start_idx+name_start_idx}')
...
get_stats(args.split, args.sample_type, args.exp, args.start_idx, args.config_id, args.samples_per_job, args.name_start_idx)
