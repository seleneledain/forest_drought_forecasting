...
def train_all(method, num_layers, hidden_dim, lr, output_dim, config_id, feature_imp=None):
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'simple_cleanfilt_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
...
#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/simple_filt_0.000380_1_120.stdout -err sj_out/simple_filt_0.000380_1_120.stderr python train_simple_clean_filter.py --method dir --num_layers 1 --hidden_dim 120 --lr 0.000380 --output_dim 1 --config_id train_config_clean_filter 
