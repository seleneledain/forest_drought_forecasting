...
def train_all(method, num_layers, hidden_dim, lr, output_dim, config_id, ndvi_idx):
    """
    ...
    :param ndvi_idx: index of NDVI in tensor after feature removal
    """
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'final10_filter_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
...
train_all(args.method, args.num_layers, args.hidden_dim, args.lr, args.output_dim, args.config_id, args.ndvi_idx)

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/final10_filter_0.0001041_2_32.stdout -err sj_out/final10_filter_0.0001041_2_32.stderr python train_all_clean_filter.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_final_config_clean_filter --ndvi_idx 2
