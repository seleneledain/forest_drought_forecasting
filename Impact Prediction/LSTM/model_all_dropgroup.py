...
def test_model(method, model, epoch, loss_function, batch_size, n_batch, n_timesteps_in,  n_timesteps_out, n_feats_in, n_feats_out, remove_band, feature_set, experiment, split, start_batch, client, run_id, sample_type, exp, cp_idx, dt_string, device, ndvi_idx, checkpoint_folder=None):
    """
    Train model in one epoch
