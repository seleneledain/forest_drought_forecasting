...
now = datetime.now()
dt_string = 'optuna_filter_simple_'+now.strftime("%d/%m/%Y")
...
study = optuna.create_study(
        ...
        study_name="tuning-15-02-2023-filtersimple",
...
#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/optuna_filtersimple.stdout -err sj_out/optuna_filtersimple.stderr python hyperparam_optuna_filter_simple.py 
