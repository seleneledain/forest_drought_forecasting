...
config_id = 'train_config_clean_update'
...
now = datetime.now()
dt_string = 'optuna_simple_'+now.strftime("%d/%m/%Y")
...
optuna.delete_study(study_name="tuning-15-02-2023-fast", storage="sqlite:///example-study.db")

study = optuna.create_study(
        storage="sqlite:///example-study.db",  # Specify the storage URL here.
        study_name="tuning-15-02-2023-fast",
...
#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/optuna_upd_simple.stdout -err sj_out/optuna_upd_simple.stderr python hyperparam_optuna_simple.py 
