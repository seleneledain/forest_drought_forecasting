...
now = datetime.now()
dt_string = 'resume_optuna_all_'+now.strftime("%d/%m/%Y")
...
#optuna.delete_study(study_name="tuning-15-02-2023-all", storage="sqlite:///example-study.db")

study = optuna.create_study(
        storage="sqlite:///example-study.db",  # Specify the storage URL here.
        study_name="tuning-15-02-2023-all",
...
#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/optuna_upd_all.stdout -err sj_out/optuna_upd_all.stderr python hyperparam_optuna_all.py 
