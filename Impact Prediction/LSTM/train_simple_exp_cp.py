...
def train_simple_exp(method, num_layers, hidden_dim, lr, output_dim, config_id):
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'simple_cp_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
...
# python train_simple_exp_cp.py --method dir --num_layers 1 --hidden_dim 10 --lr 0.001 --output_dim 1 --config_id train_config_nofilter_cp

# jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/simple_cp_0.00129_2_96.stdout -err sj_out/simple_cp_0.00129_2_96.stderr python train_simple_exp_cp.py --method dir --num_layers 2 --hidden_dim 96 --lr 0.00129 --output_dim 1 --config_id train_config_nofilter_cp
