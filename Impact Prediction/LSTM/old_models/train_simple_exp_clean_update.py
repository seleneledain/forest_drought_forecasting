...
def train_simple_exp(method, num_layers, hidden_dim, lr, output_dim, config_id):
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'cleanupd_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
...
#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/cleanupd_0.001_2_64.stdout -err sj_out/cleanupd_0.001_2_64.stderr python train_simple_exp_clean_update.py --method dir --num_layers 2 --hidden_dim 64 --lr 0.001 --output_dim 1 --config_id train_config_clean_update

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/cleanupd_0.001_4_16.stdout -err sj_out/cleanupd_0.001_4_16.stderr python train_simple_exp_clean_update.py --method dir --num_layers 4 --hidden_dim 16 --lr 0.001 --output_dim 1 --config_id train_config_clean_update
