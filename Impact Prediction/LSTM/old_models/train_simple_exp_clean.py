...
def train_simple_exp(method, num_layers, hidden_dim, lr, output_dim, config_id):
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'clean_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
...
# python train_simple_exp_clean.py --method dir --num_layers 1 --hidden_dim 10 --lr 0.001 --output_dim 1 --config_id train_config_clean
