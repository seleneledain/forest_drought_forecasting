...
def train_simple_exp(method, num_layers, hidden_dim, lr, output_dim, config_id):
    """
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = 'allcleanupd_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
    ...
    for ix_epoch in tqdm(range(1)): #range(sim_params["num_epochs"])
...
train_simple_exp(args.method, args.num_layers, args.hidden_dim, args.lr, args.output_dim, args.config_id)

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/allcleanupd_0.001_2_64.stdout -err sj_out/allcleanupd_0.001_2_64.stderr python train_all_clean_update.py --method dir --num_layers 2 --hidden_dim 64 --lr 0.001 --output_dim 1 --config_id train_all_config_clean_update

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/allcleanupd_0.001_4_16.stdout -err sj_out/allcleanupd_0.001_4_16.stderr python train_all_clean_update.py --method dir --num_layers 4 --hidden_dim 16 --lr 0.001 --output_dim 1 --config_id train_all_config_clean_update

# jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/cleanupd_debug.stdout -err sj_out/cleanupd_debug.stderr python train_all_clean_update.py --method dir --num_layers 4 --hidden_dim 16 --lr 0.001 --output_dim 1 --config_id train_all_config_clean_update
