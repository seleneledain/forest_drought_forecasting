...
from model_all_dropgroup import *
...
def train_all(method, num_layers, hidden_dim, lr, output_dim, config_id, ndvi_idx, feature_imp=None):
    """
    ...
    if checkpoint_file is None:
        ...
        now = datetime.now()
        dt_string = f'{feature_imp}_filter_'+now.strftime("%d/%m/%Y")+f'_{lr}_{num_layers}_{hidden_dim}'
        #dt_string = 'debug'
    ...
    for ix_epoch in tqdm(range(sim_params["num_epochs"])): 
        ...
        total_loss, epoch_r2 = train_model(method=method, model=model, epoch=ix_epoch, loss_function=criterion, optimizer=optimizer, 
                                 ...
                                 sample_type=sample_type, exp=exp, cp_idx=cp_idx, device=device, ndvi_idx=ndvi_idx)
        ...
        val_loss, val_r2 = test_model(method=method, model=model, epoch=ix_epoch, loss_function=criterion, 
                                 ...
                                 sample_type=sample_type, exp=exp_val, cp_idx=cp_idx, dt_string=dt_string, device=device, ndvi_idx=ndvi_idx)
    ...
    test_loss, test_r2 = test_model(method=method, model=model, epoch=ix_epoch, loss_function=criterion, 
                                 ...
                                 sample_type=sample_type, exp=exp_te, cp_idx=cp_idx, dt_string=dt_string, device=device, ndvi_idx=ndvi_idx)
...
parser.add_argument('--feature_imp', type=str)

args = parser.parse_args()

train_all(args.method, args.num_layers, args.hidden_dim, args.lr, args.output_dim, args.config_id, args.ndvi_idx, args.feature_imp)

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/sen_filter_0.0001041_2_32.stdout -err sj_out/sen_filter_0.0001041_2_32.stderr python train_all_clean_filter_dropgroup.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_sen_config_clean_filter --ndvi_idx 0 --feature_imp sen

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/era_filter_0.0001041_2_32.stdout -err sj_out/era_filter_0.0001041_2_32.stderr python train_all_clean_filter_dropgroup.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_era_config_clean_filter --ndvi_idx 14 --feature_imp era

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/topo_filter_0.0001041_2_32.stdout -err sj_out/topo_filter_0.0001041_2_32.stderr python train_all_clean_filter_dropgroup.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_topo_config_clean_filter --ndvi_idx 14 --feature_imp topo

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/soil_filter_0.0001041_2_32.stdout -err sj_out/soil_filter_0.0001041_2_32.stderr python train_all_clean_filter_dropgroup.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_soil_config_clean_filter --ndvi_idx 14 --feature_imp soil

#jbsub -q x86_24h -cores 1x8+1 -mem 128G -out sj_out/veg_filter_0.0001041_2_32.stdout -err sj_out/veg_filter_0.0001041_2_32.stderr python train_all_clean_filter_dropgroup.py --method dir --num_layers 2 --hidden_dim 32 --lr 0.0001041 --output_dim 1 --config_id train_veg_config_clean_filter --ndvi_idx 14 --feature_imp veg
