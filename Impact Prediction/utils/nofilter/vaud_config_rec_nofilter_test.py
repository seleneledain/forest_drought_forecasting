...
sim_params = {
    ...
    "num_steps":1,
    "exp": "clean_update",
    "exp_val": "clean_update",
    "exp_test": "clean_update",
...
test_dataset_params = { #Same as train, only change parts that differ
    # On CCC
    "focus_time": ['2018-01-01', '2021-11-30'], #default [None, None]
    "focus_list": [[46.630, 6.379, 46.700, 6.507]], #default []    
}
...
test_sampler_params = {
    # On CCC
    "roi": [6.4953, 46.664, 6.4965, 46.6655], #default None
    "length": 6000
    #"mask_threshold":0 
}
...
#########
# PATHS, REGIONS AND FEATURES ARE IMPORTANT, OTHER PARAMETERS DONT MATTER
...
train_dataset_params = {
    ...
    "focus_time": ['2015-08-09', '2021-12-31'], #default [None, None]
    "focus_list": [[46.630, 6.379, 46.700, 6.507]], #default []
