...
train_dataset_params = {
    ...
    "focus_time": ['2017-01-10', '2018-12-01'], #default [None, None]
    "focus_list": [[46.000,7.02,46.372,7.435]], #[47.1054, 7.5414, 47.1587, 7.5989]], #default []
...
val_dataset_params = { #Same as train, only change parts that differ
    # On CCC
    "focus_time": ['2019-05-05', '2019-08-28'], #default [None, None]
...
test1_dataset_params = { #Same as train, only change parts that differ
    # On CCC
    "focus_time": ['2020-05-04', '2020-08-27'], #default [None, None]
    "focus_list": [[47.1054, 7.5414, 47.1587, 7.5989]], #default []    
}

test2_dataset_params = { #Same as train, only change parts that differ
    # On CCC
    "focus_time": ['2021-05-04', '2021-08-27'], #default [None, None]
    "focus_list": [[47.1054, 7.5414, 47.1587, 7.5989]], #default []    
}
