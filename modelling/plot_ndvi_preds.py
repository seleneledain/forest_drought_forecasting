...
def plot_ndvi_preds(truth_path, pred_path, coord_range, time_range, ndvi_idx):
...
if __name__ == '__main__':
    ...
    plot_ndvi_preds(args.truth_path, args.pred_path, args.coord_range, args.time_range, args.ndvi_idx)
    
    # python modelling/plot_ndvi_preds.py --truth_path /data/scratch/selene/test/iid --pred_path /data/scratch/selene/test/iid_preds --ndvi_idx 5
