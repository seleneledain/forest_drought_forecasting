...
def parse_setting(setting_file, track = None):
    ...
    gpus = setting_dict["Trainer"]["accelerator"] if "accelerator" in setting_dict["Trainer"] else setting_dict["Trainer"]["devices"]
    ...
    if setting_dict["Architecture"] in ["drought-lstm"]:  
