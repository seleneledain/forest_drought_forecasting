...
def split_train_test(data_paths, dir_path, coord_range=None, time_range=None):
    ...
    # Filter the .npy file (of format '{start_yr}_{start_month}_{start_day}_{end_yr}_{end_month}_{end_day}_{lon}_{lat}_{width}_{height}*.npy') as for the .npz files.
...
if __name__ == '__main__':
    ...
    split_train_test(args.data_paths, args.dir_path, args.coord_range, args.time_range)
