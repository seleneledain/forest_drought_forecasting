"""
This script realigns rasters with Sentinel 2 pixels.
...
target_file = 'High res  imagery (ESA Sentinel 2)-Band 2 (blue)-04_05_2019T00_00_00.tiff' #or any sentinel 2 data
dir_path = 'wsl/'

for file in os.listdir(dir_path):
    if file.endswith('_resampled.tiff'):
        raster_matched = match_raster_to_target_nocrop(dir_path + file, target_file, output_suffix='_matched')
